...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="tabs" style="width: 100%;">
        ...
        <div id="tabs-1">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <table width="100%" style="border: 0" cellpadding="10">
                <tr>
                    <td>
    ...
    <div style="overflow: scroll; height: 170px;">
        <table width="100%" style="border: none; height: 10%; width: 100%;">
            <tr>
                <td style="width: 25%; height: 10%;">
                    <table id="gridAdvance" class="scroll" cellpadding="0" cellspacing="0" width="50%">
                    </table>
                </td>
                <td>
                    <table id="gridExpanse" class="scroll" cellpadding="0" cellspacing="0" width="50%">
                    </table>
                </td>
                <td style="width: 25%">
